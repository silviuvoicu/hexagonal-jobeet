...
namespace Jobeet\Bundle\FinderBundle\Form\Transformer;
...
class CategoryToNameTransformer implements DataTransformerInterface
{
     ...
     * passed.
     *
     * @param mixed $category The value in the original representation
     *
     ...
     * is passed.
     *
     * @param mixed $category The value in the transformed representation
     *
